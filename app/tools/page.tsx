...
export const metadata: Metadata = {
  title: 'Tools',
  description:
    'Explore free privacy and security tools by Temp Mail Lab, including the password generator for strong credentials and safer account setup.',
  alternates: {
    ...
    <div className="min-h-screen bg-transparent pb-24">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="mt-10 grid gap-5 md:grid-cols-2">
          ...
          <div className="rounded-[2rem] border border-dashed border-gray-300/80 bg-white/70 p-6 ring-1 ring-black/5 dark:border-white/15 dark:bg-white/5 dark:ring-white/10">
            <p className="text-xs font-black uppercase tracking-[0.2em] text-gray-500 dark:text-gray-400">
              Coming Soon
            </p>
            <h2 className="mt-3 text-2xl font-black text-gray-900 dark:text-gray-100">
