...
const termsDescription =
  'Read Temp Mail Lab Terms of Service to understand acceptable use, temporary inbox limitations, legal responsibilities, liability terms, and the official support contact process.';
      ...
      <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
        ...
        <section id="contact">
          ...
          <p>
            ...
            contact us at legal [at] tempmaillab [dot] com.
          </p>
        </section>
      </div>
    </div>
