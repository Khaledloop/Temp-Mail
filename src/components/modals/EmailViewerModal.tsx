...
export function EmailViewerModal() {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed inset-2 sm:inset-auto sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-2xl z-50">
        <div className="h-full sm:h-[90vh] sm:max-h-[90vh] max-h-[92vh] overflow-hidden">
          <EmailViewer
            email={selectedEmail}
